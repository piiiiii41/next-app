...
const list = [
  ...
  department: "開発センター",
  date: "2021/xx/xx",
  comment: "講師の説明が、具体的で実話に基づいて語られており納得感があった。プロジェクトリーダーをこれから経験していく人や、実際に経験しているが、うまくメンバーを管理できていない人におすすめ。教材が多く、資料を参照するのが大変なため注意。"
  },
  ...
  return (
    <div className={topStyle.root}>
        <Grid item xs={12}>
          <Paper className={topStyle.paper} id="paper">
            <Grid container justify="space-between" style={{padding: '15px'}}>
              <Grid item>
                ...
                <div style={{color: '#0070c1', fontSize: '14px', paddingTop: '10px', paddingLeft: '10px'}}>
               🏢 富士通ラーニングメディア
              </div>
              </Grid>
          ...
          🔗応募はコチラ ：　https://www.kcc.knowledgewing.com/icm/srv/course-application/init-detail?cd=FLM&pcd=FLMC&cscd=ULD43R
          </div>
          <br/>
          ...
          <Grid container justify="space-between">
            <Grid item>
              <Grid container spacing={2} style={{width: '1200px'}}>
                ...
                <Grid item xs={10} style={{alignItems: 'flex-end', fontSize: '14px', paddingTop: '15px'}}>
           ...
           { list.map((value) => <li style={{paddingTop: '15px'}}>
            ...
            <Grid item xs={11}>
              <Paper className={detailStyle.paper}>
                <div id="blue" className="blue">
                  評価:{value['eva']}     【 講師：{value['teacher']}　教材：{value['teachmaterial']}　レベル：{value['lavel']}　受講推奨グレード：{value['grade']}】　
